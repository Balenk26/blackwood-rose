        ...
        <div className="nav-top-container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%', maxWidth: '1600px', margin: '0 auto', height: '100px', padding: '0 24px' }}>
          ...
          <div className="nav-right-col" style={{ width: '120px', display: 'flex', justifyContent: 'flex-end', alignItems: 'center', gap: '16px', position: 'relative' }} ref={cartRef}>
            ...
            <Show when="signed-in">
              <UserButton>
                <UserButton.MenuItems>
                  {/* SECRET ADMIN LINK - ONLY VISIBLE TO SONIA */}
                  {isAdmin && (
                  ...
                  {/* Standard customer options remain visible to everyone */}
            ...
            <button onClick={() => setIsCartOpen(!isCartOpen)} style={{ color: '#D4AF37', background: 'transparent', border: 'none', cursor: 'pointer', position: 'relative', padding: 0 }}>
              ...
              <span style={{ position: 'absolute', bottom: '-6px', right: '-8px', backgroundColor: '#ffffff', color: '#000000', fontSize: '10px', fontWeight: 'bold', height: '18px', width: '18px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyYontent: 'center' }}>
