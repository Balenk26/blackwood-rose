  ...
  return (
    <div className="min-h-screen bg-white flex flex-col text-black">
      ...
      >
        ...
        {/* FIXED: Pushed top to 140px so it perfectly clears the floating Navbar */}
        <aside 
          className="space-y-10 bg-white z-10 pr-6 pb-8"
          style={{ position: 'sticky', top: '140px', height: 'fit-content', maxHeight: '80vh', overflowY: 'auto' }}
        >
          
          {/* FIXED: Removed duplicate branding, added elegant "Refine" title */}
